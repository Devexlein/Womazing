<?php
    ...
    $messageUser = htmlspecialchars($_POST['message']);
    ...
    $message = "Текст письма:
        ...
        E-mail: $email<br>
        Телефон: $tel<br>
        Сообщение клиента: $messageUser<br>
    ...
    $success = mail("ms.revizor@bk.ru", $subject, $message, $headers);
    ...
    $f = fopen("leads.xls", "a+");
    fwrite($f," <tr>");    
    fwrite($f," <td>$email</td> <td>$name</td> <td>$tel</td> <td>$messageUser</td>");   
